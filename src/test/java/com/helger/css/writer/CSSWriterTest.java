...
public final class CSSWriterTest extends AbstractCSS30TestCase
{
  ...
  public void testIndentation ()
  {
    ...
    final String writtenCss = aWriter.getCSSAsString (aCSS);
    final String expectedCss = "h1 {\n"
            + "  color:red;\n"
            + "  margin:1px;\n"
            + "}\n"
            + "\n"
    ...
    assertEquals (expectedCss, writtenCss);
  ...
  public void testIndentationNested ()
  {
    ...
    final CSSWriter aWriter = new CSSWriter (aSettings).setWriteHeaderText (false);
    final String writtenCss = aWriter.getCSSAsString (aCSS);
    final String expectedCss = "@media print {\n"
            + "  h1 {\n"
            + "    color:red;\n"
            + "    margin:1px;\n"
            + "  }\n"
  ...
  public void testRemoveUnnecessaryCode1 ()
  {
    ...
    final CSSWriter aWriter = new CSSWriter (aSettings).setWriteHeaderText (false);
    final String writtenCss = aWriter.getCSSAsString (aCSS).replaceAll("\\s","");
    final String expectedCss = "h1 {\n"
            + "  color:red;\n"
            + "  margin:1px;\n"
            + "}\n"
    ...
    assertEquals (expectedCss.replaceAll("\\s",""), writtenCss);
  }
