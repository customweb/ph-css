...
public enum ECSSNodeType
{
  ...
  STYLEPAGERULEDECLARATION(ParserCSS21TreeConstants.JJTSTYLEDECLARATION, ParserCSS30TreeConstants.JJTSTYLEPAGERULEDECLARATION),
  STYLEPAGERULEDECLARATIONLIST(ParserCSS21TreeConstants.JJTSTYLEDECLARATIONLIST, ParserCSS30TreeConstants.JJTSTYLEPAGERULEDECLARATIONLIST),
  // style rule -- selector
